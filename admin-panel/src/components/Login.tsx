                    ...
                    <div className="col-sm-8 col-md-6 col-lg-8">
                        <div className="card" style={{
                            ...
                            <div className="card-body p-3">
                                <h2 className="card-title text-center mb-3">{isSignUp ? 'Admin Sign Up' : 'Admin Login'}</h2>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-3">
                                        <h5 className="text-muted mb-2 fw-bold" style={{ fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                                            Account Information
                                        </h5>
                                        <div className="mb-3">
